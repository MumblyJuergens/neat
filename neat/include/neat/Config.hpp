...
class Config
{
  public:
    ...
    real_t species_compatibility_threshold = 0.5_r;
    real_t species_disjoint_coefficient = 1.0_r;
    real_t species_weight_coefficient = 0.5_r;
    real_t species_compatibility_modifier = 0.3_r;
    ...
    {
        ar(setup_population_size, setup_input_nodes, setup_output_nodes, setup_connect_bias, setup_bias_input,
           setup_inital_connection_rate,

           species_maximum_staleness, species_compatibility_threshold, species_disjoint_coefficient,
           species_weight_coefficient, species_compatibility_modifier, species_count_target,

           crossover_elite_size, crossover_use_adjusted_fitness,

           mutate_weight_rate, mutate_weight_amount, mutate_weight_min, mutate_weight_max, mutate_redraw_weight,
           mutate_new_connection_rate, mutate_new_node_rate, mutate_disable_node_rate,
