...
struct Flappy
{
    ...
    struct SimHandler : public GameHandler
    {
        ...
        SimHandler(Flappy &floppy) : userData{&floppy.pipes, &floppy.birds_mbo}
        {
            ...
            neat::Config cfg{
                ...
                .species_compatibility_threshold = 5.0_r,
            };
    ...
    void init(const bool simulate)
    {
        ...
        pipe_vao.add(program, pipes_mbo.buffer(), nameof(&dummy::translation), &dummy::translation,
                     glube::AttributeConfig{
                         .binding_index = 1,
                         .divisor = 1,
                     });
        ...
        bird_vao.add(program, birds_mbo.buffer(), nameof(&dummy::translation), &dummy::translation,
                     glube::AttributeConfig{
                         .binding_index = 1,
                         .divisor = 1,
                     });
