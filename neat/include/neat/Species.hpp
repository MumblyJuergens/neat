...
class [[nodiscard]] Species final
{
  ...
  public:
    ...
    [[nodiscard]] constexpr auto average_fitness() const noexcept
    {
        return m_total_fitness / static_cast<real_t>(m_size);
    }
    [[nodiscard]] constexpr auto adjusted_fitness() const noexcept
    {
        return m_total_adjusted_fitness / static_cast<real_t>(m_size);
    }
